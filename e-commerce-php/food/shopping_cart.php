...
<div class="txt-heading" style="height:40px;"><span style="margin-left:100px;"><a href="../index2.php" style="color:#33B6CB;text-decoration:none;">Home/</a> Product/<a href="women.php" style="color:#33B6CB;text-decoration:none;">Food/</a> AddToCart</span></div>
...
<?php foreach ($_SESSION["cart_item"] as $item) { 
		// $product_info = $db_handle->runQuery("SELECT * FROM productfood WHERE code = '" . $item["code"] . "'");
...
?>
	<div style="background:#fff;" class="product-item" onMouseOver="document.getElementById('remove<?php echo $item["code"]; ?>').style.display='block';"  onMouseOut="document.getElementById('remove<?php echo $item["code"]; ?>').style.display='';" >
		...
		<div class="product-price"><?php echo $item["price"]."Rupees"; ?></div>
...
<a href="food.php" title="Cart" class="btn btn-primary" style="border-radius:5px;width:180px;">Continue Shopping</a>
