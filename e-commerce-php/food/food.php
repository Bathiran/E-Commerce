...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM productfood WHERE code='" . $_GET["code"] . "'");
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#33B6CB;margin-left:120px;">Home/</a> Products/ <a href="women.php" style="color:#33B6CB;text-decoration: none;">Food</a></div>
 ...
 <div class="container-fluid" style="width:90%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;color:#428bca;">
              ...
              <ul>
                <li class=""><a href="../kitchen/kitchen.php">Kitchen</a></li>
                <li><a href="food.php">Food</a></li>
                <li><a href="../furniture/accessesoris.php">Furniture</a></li>
  ...
  ?>
    <div class="product-item" style="background:#fff;">
      <form method="post" action="food.php?action=add&code=<?php echo $product_array[$key]["code"]; ?>">
        <input type="hidden" name="img_path" value="foodproduct/<?php echo $product_array[$key]["image"]; ?>">
      <div class="product-image"><img style="max-height: 250px;max-width: 250px;" src="foodproduct/<?php echo $product_array[$key]["image"]; ?>"></div>
      ...
      <div class="product-price"><?php echo $product_array[$key]["price"]. "Rupess"; ?></div>
