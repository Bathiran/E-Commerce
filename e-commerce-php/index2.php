...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#myPage">SaiRam.com</a>
    </div>
...
<li><a href="" style="color: #ffffff;">Hi:<?php echo $row ['username']; ?></a></li>
      <li class="dropdown">
          ...
          <ul class="dropdown-menu" style="background: #e3e3e3; border-radius: 5px;font-weight: bolder;">
            <li><a href="kitchen/profile.php<?php echo '?mem_id='.$id; ?>">EditProfile</a></li>
            <li><a href="kitchen/logout.php">LogOut</a></li>
          </ul>
        </li>
<?php } ?>
      </ul>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="sai1.jpg" alt="New York" width="1200" height="700" style="min-height:577px;max-height:577px;">      
      </div>

      <div class="item">
        <img src="sai2.JPG" alt="Chicago" width="1200" height="700" style="min-height:577px;max-height:577px;">     
      </div>
...
<div id="shop" class="container text-center">
  ...
  <div class="row">
    <div class="col-sm-4" style="float:right;right:-60px;">
      <?php
      $result = mysqli_query($conn,"SELECT * FROM productfood");
      $num_rows = mysqli_num_rows($result);
      ?>
      
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px; border-color:none;background:#000;color:#ffffff;">Food <span style="background: red;border-radius: 5px;"> <?php echo $num_rows; ?> </span> </strong></p><br>
      <a href="food/food.php">
        <img src="Food.jpg" class="img-circle person" alt="Random Name" width="255" style="min-height:355px;min-width:200px; " >
      </a>
    </div>
  <?php 
  $result = mysqli_query($conn,"SELECT * FROM kitchenproducts");
  $num_rows = mysqli_num_rows($result);
  ?>
                          
    <div class="col-sm-4" style="float:right;right:-60px;">
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px;background:#000;color:#ffffff;">Kitchen <span style="background: red;border-radius: 5px; min-width: 100px;"><?php echo $num_rows; ?></span></strong></p><br>
      <a href="kitchen/kitchen.php">
        <img src="kitchenproducts.jpg" class="img-circle person" alt="Random Name" width="255" height="255" style="min-height:355px;min-width:200px;float:right;">
      </a>
    </div>
    <div class="col-sm-4" style="float:right;right:-60px;">
     <?php
     ...
     $num_rows = mysqli_num_rows($result);
     ?>
      <p class="text-center"><strong class="btn btn-success" style="border-radius:5px;background:#000;color:#ffffff;">Furniture <span style="background: red;border-radius: 5px;"><?php echo $num_rows;?></span></strong></p><br>
      <a href="furniture/accessesoris.php">
        <img src="furniture.jpg" class="img-circle person" alt="Random Name" width="255" height="255"style="min-height:355px;min-width:200px;float:right;">
      </a>
    </div>
  </div>
</div>
...
<div id="tour" class="bg-1">
  <div class="container">
    ...
    <p class="text-center">SaiRam.com<br>
...
<div id="contact" class="container">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span>SaiRam, Jaffna</p>
      <p><span class="glyphicon glyphicon-phone"></span>Phone: +0212241536 /0771535689</p>
      <p><span class="glyphicon glyphicon-envelope"></span>Email: contact@SaiRam.com</p>
    </div>
    <div class="col-md-8">
      <div class="row">
...
<footer class="text-center">
 ...
 © 2022 AllRight Reserved SaiRam.com
</p> 
</footer>
