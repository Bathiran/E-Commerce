...
switch($_GET["action"]) {
  case "add":
    if(!empty($_POST["quantity"])) {
      $productByCode = $db_handle->runQuery("SELECT * FROM furniture WHERE code='" . $_GET["code"] . "'");
...
<br><br><br>
  <div class="txt-heading" style="text-align:left;color:#d5d5d5;"><a href="../index2.php" style="text-decoration:none;color:#33B6CB;margin-left:120px;">Home/</a> Products/ <a href="" style="color:#33B6CB;text-decoration: none;">Furniture</a></div>
