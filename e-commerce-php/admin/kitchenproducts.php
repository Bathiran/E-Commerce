...
<br><br><br>
<div style="background: #000;max-width: 100%;"><p style="margin-left: 100px;font-weight: bolder;">Admin/<a href="index.php" style="text-decoration: none;color: #428bca"> Home/</a> <a href="" style="text-decoration: none;color: #428bca">kitchenProducts</a></p></div>
 <div class="container-fluid" style="max-width: 95%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;">
      ...
      <p><img src="profile/admin.jfif" style="height: 200px;width: 200px;border-radius: 360px;"></p>
      <div>
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      <p></p>
          ...
          <tbody>
              <?php
              $result= mysqli_query($conn,"select * from kitchenproducts order by id DESC ") or die (mysqli_error());
          ...
          <tr>
            ...
            <td><img src="../kitchen/product/<?php echo $row ['image']?>" style="height: 100px;width: 100px;"></td>
            <td class="center">
              <a class="btn btn-danger" href="#delete<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
                <i class="glyphicon glyphicon-trash icon-white"></i>
              </a>
              <?php include('kitchenproductdeletedelete.php'); ?>
            </td>
          </tr>
              <?php } ?>
          </tbody>
