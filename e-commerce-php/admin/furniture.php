  ...
  <div class="row">
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      <p></p>
          ...
          <tbody>
              <?php
              $result= mysqli_query($conn,"select * from furniture order by id DESC ") or die (mysqli_error());
          ...
          <tr>
            ...
            <td><img src="../furniture/product/<?php echo $row ['image']?>" style="height: 100px;width: 100px;"></td>
            <td class="center">
              <a class="btn btn-danger" href="#delete<?php echo $id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
                <i class="glyphicon glyphicon-trash icon-white"></i>
              </a>
              <?php include('furnituredelete.php'); ?>
            </td>
          </tr>
              <?php } ?>
          </tbody>
