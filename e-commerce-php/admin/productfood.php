...
<br><br><br>
<div style="background: #000;max-width: 100%;"><p style="margin-left: 100px;font-weight: bolder;">Admin/<a href="index.php" style="text-decoration: none;color: #428bca"> Home/</a> <a href="" style="text-decoration: none;color: #428bca">productfood</a></p></div>
 <div class="container-fluid" style="max-width: 95%;">
  <div class="row">
    <div class="col-sm-2" style="background-color:#e3e3e3;">
      <p style="color: #428bca;font-weight: bolder;margin-left: 30px;">Wellcome:<?php echo $row ['username']; ?></p>
    ...
    <div class="col-sm-9" style="background-color:#e3e3e3;margin-left:10px;">
      <p></p>
          ...
          <tbody>
              <?php
              $result= mysqli_query($conn,"select * from productfood order by id DESC ") or die (mysqli_error());
          ...
          <tr>
            ...
            <td class="center">
              ...
              <?php include('productfooddeletedelete.php'); ?>
            </td>
          </tr>
              <?php } ?>
          </tbody>
