...
<nav class="navbar navbar-default navbar-fixed-top" style="background:#000;">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" id="font" href="../index2.php" >SiRam.com</a>
    </div>
...
<div class="txt-heading" style="height:40px;"><span style="margin-left:100px;"><a href="../index2.php" style="color:#33B6CB;text-decoration:none;">Home/</a> Product/<a href="kitchen.php" style="color:#33B6CB;text-decoration:none;">Kitchen/</a> AddToCart</span></div>
...
<?php foreach ($_SESSION["cart_item"] as $item) { 
		// $product_info = $db_handle->runQuery("SELECT * FROM kitchenproducts WHERE code = '" . $item["code"] . "'");
...
?>
	<div style="background:#fff;" class="product-item" onMouseOver="document.getElementById('remove<?php echo $item["code"]; ?>').style.display='block';"  onMouseOut="document.getElementById('remove<?php echo $item["code"]; ?>').style.display='';" >
		...
		<div class="product-price"><?php echo $item["price"]."Rubess"; ?></div>
...
<span class="label label-danger" style="margin-left:300px;font-size:20px;">Your Total Price Is: <span id="total_price"><?php echo  number_format($total_price,2). "Rupees "; ?></span></span>
...
<a href="kitchen.php" title="Cart" class="btn btn-primary" style="border-radius:5px;width:180px;">Continue Shopping</a>
